...
{ lib, mkCoqDerivation, which, coq
  ...
  , mathcomp, coq-elpi, mathcomp-algebra-tactics, mathcomp-analysis, mathcomp-zify
  , version ? null }:
...
## - or its version is overridden (by a branch, PR, url or path) in `.nix/config.nix`.
  ...
  propagatedBuildInputs = [ mathcomp coq-elpi mathcomp-algebra-tactics
    mathcomp-analysis mathcomp-zify ]; ## e.g. `= [ mathcomp coq-elpi ]`
